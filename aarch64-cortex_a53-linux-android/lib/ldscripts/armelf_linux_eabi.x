...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/aryan/KudProject/src/tc/out/aarch64-cortex_a53-linux-android/aarch64-cortex_a53-linux-android/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
